    ...
    axios
      ...
      .then(response => {
        const pinkcode = new Discord.MessageEmbed()
          ...
          .setDescription(
            "Bu tablo dünya genelinin Covid-19 tablosudur \n Ülkeler hakkında bilgi almak için " +
              ` \`.covid19 [ülkenin ingilizce ülke kodu veya ingilizce ülke ismi]\` `
          )
    ...
    axios
      ...
      .catch(error => {
        message.channel.send(
          ":x: Hata \n Lütfen ülke girerken ülkenin ingilizce ismini giriniz. \n Bu komutta şuanlık Türkçe dil desteği verilmemektedir."
        );
        console.log(error);
      });
  }
